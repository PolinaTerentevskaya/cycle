...
console.log(str1); // выведет '123456789'
...
console.log(str2); // выведет '987654321'
...
console.log(str3); // выведет '987654321'

let str5 ='';
for (let i = 10; i <= 1000; i++) {
	let str5 = String(i); // преобразуем число в строку
	console.log(str5[0]);
}

let str6 ='';
for (let i = 10; i <= 1000; i++) {
	let str6 = String(i); // преобразуем число в строку
	console.log(parseInt(str6[0])+parseInt(str6[1]));
}
